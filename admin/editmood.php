<?php
	...
	$stmt = $mood->runQuery("SELECT * FROM mood WHERE id = '".strip_tags($_GET['moodid'])."'");
	$stmt->execute();
...
if(isset($_POST['update-mood']))
{
	...
	else
	{
		try
		{
				...
				if($mood->updateMood($moodadd,$moodid)){	
...
<div class="container-fluid" style="margin-top:80px;">
    ...
    <div class="container">
        ...
        <input type="hidden" name="moodid" value="<?php echo $_GET['moodid']; ?>"  />
            <h2 class="form-signin-heading">Update Mood</h2><hr />
            <div class="form-group">
            <textarea class="form-control" name="mood"><?php echo $userRow['mood'] ?></textarea>
            </div>
            <div class="clearfix"></div><hr />
            <div class="form-group">
            	<button type="submit" class="btn btn-primary" name="update-mood">
